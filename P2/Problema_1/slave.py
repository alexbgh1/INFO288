...
# --- INIT LOGGING ---
logging.basicConfig(filename=slave_config["log_location"], level=logging.INFO)
# Desactivamos el log de flask solo por fines de tener el log final al solicitado
...
def search_articulo(clave, parametro):
    ...
    # timestamp ; buscar_categoria; ini
    logging.info( str(int(time.time())) + ';buscar_'+clave+';word_'+str(parametro)+';fin')
    return results
